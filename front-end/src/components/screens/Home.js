                        ...
                        return (
                            ...
                            <div className="card home-card" key={item._id}>
                                ...
                                <div className="card-image mar">
                                    {
                                        item.photo ? <img style={{ maxHeight: "500px" }} src={item.photo} /> : <h6>{item.body}</h6>
                                    }
                                ...
                                <div className="card-content">
                                    ...
                                    <div className='comenntcard comenntcard-body'>
                                        <h6><strong>{item.likes.length} likes &nbsp;{item.comments.length} comments</strong></h6>
                                    </div>
                                    <div className='comenntcard comenntcard-body'>
                                        <h6><strong className='titlee'>{item.title}</strong></h6>
                                        <hr />
                                    ...
                                    <div className='comenntcard comenntcard-body'>
                                        {
                                            item.comments.length == 0
                                                ? <h6><strong>No comments yet..</strong></h6>
                                                : item.comments.length === 1
                                                    ? <h6><strong>View 1 comment</strong></h6>
                                                    :
